                    ...
                    DisclosureGroup {
                        if let questions = tag.questions {
                            ForEach(questions) { question in
                                NavigationLink(destination: navigationMap.destinationForQuestion?(question)) {QuestionRow(question: question)}
                            }
                        }
                    } label: {
